...
価値あるプロダクトを作りたいというのが根底にあり、プログラミングは現在それを実現するための有用な手段だと思っています。  
ユーザーの求める価値の実現がノーコードで済むならオーバースペックなことせずにノーコードでいいと思うタイプです。  
...
#### 自社の既存のWebアプリケーション開発(2021/9~2022/6)
##### [担当業務]
- 機能追加
- 機能改善
- バグ修正 
...
詰まってもネットに情報がなさすぎて辛かったですが、issueやライブラリのコードを読んで乗り越えました。
