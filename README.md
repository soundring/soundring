...
エンジニアとしてはサーバーサイドをメインとして力を高めつつ、Web/スマホアプリなどのフロントエンドの力も一定のレベル持っておきたいです。
価値あるプロダクトを作りたいというのが根底にあり、プログラミングは現在それを実現するための有用な手段だと思っています。
ユーザーの求める価値の実現がノーコードで済むならオーバースペックなことせずにノーコードでええやんと思うタイプです。
...
#### 自社の既存のWebアプリケーションのフロントエンド刷新(2022/11/1~)
##### [担当業務]
