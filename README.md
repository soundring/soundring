...
典型的な大企業みたく指示を受けて動く環境より、自走できる環境を好みます。  
職種関係なく認識を共有しながら仕事を進めていくことを重要視しているため、コミュニケーションの取りやすいフラットな組織で貢献できると思います。  
知的好奇心が強いため、技術的なことに関係なく色んな分野について学んでいます。  
エンジニアとしてはサーバーサイドをメインとして力を高めつつも、Web/スマホアプリなどのフロントエンドの力も一定のレベル持っておきたいです。  
顧客にとって価値あるプロダクトを作りたいというのが根底にあり、手先が不器用で物理的なモノを作ることが困難な私にとって、プログラミングはそれを実現するための有用な手段だと思っています。  
...
|  Dart  |  3年  |  Flutter  |    |
|  Ruby  | 3年  |  Rails  |    |
|  JavaScript  | 3年  |  Backbone.js、Marionette.js、jQuery、React(1年未満)  |  HTML、CSSも同じレベルの経験  |
...
#### 社内文化への貢献
1ヶ月に1回開催の社内勉強会を立ち上げ、2年以上30回以上運営(2020/2~)
...
Flutter案件としては結構トリッキーなことしてると思います。
詰まった際にググっても情報がないので、issueやライブラリのコードを読んで乗り越えてます。
